...
app.config['MYSQL_PASSWORD'] = 'Ansh@1997'
#Change Password Accordingly
app.config['MYSQL_DB'] = 'result1'
...
def dashboard():
    ...
    student_data_list = []
    student_data_list.append(str(student_data[0]['roll_no']))
    student_data_list.append(str(student_data[0]['name']))
    student_data_list.append(float(student_data[0]['cgpi']))
    student_data_list.append(str(student_data[0]['year_rank']))
    student_data_list.append(str(student_data[0]['college_rank']))
    ...
    for i in student_subjects:
        stu_sub_list = []
        stu_sub_list.append(str(i['subject_name']))
        stu_sub_list.append(str(i['ObtainCR']))
        stu_sub_list.append(str(i['TotalCR']))
        stu_sub_list.append(float(i['semester_no'][-1]) % 10)
...
def summarized():
    ...
    for i in data:
        ...
        subjects[semester_no].append(str(i['subject_name']))
